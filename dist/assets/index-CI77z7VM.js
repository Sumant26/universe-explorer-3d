...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function pl(){return new It({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function ml(){return new It({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ja(),fragmentShader:`
...
`)}function Hm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ii(i){return i!==""}function El(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Tl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const km=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ca(i){return i.replace(km,Vm)}const zm=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function Vm(i,e){let t=ze[e];if(t===void 0){const n=zm.get(e);if(n!==void 0)t=ze[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ca(t)}const Wm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Al(i){return i.replace(Wm,qm)}function qm(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function wl(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Xm(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===hc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Mu?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Sn&&(e="SHADOWMAP_TYPE_VSM"),e}function Km(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Fi:case Gi:e="ENVMAP_TYPE_CUBE";break;case gr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ym(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Gi:e="ENVMAP_MODE_REFRACTION";break}return e}function $m(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case dc:e="ENVMAP_BLENDING_MULTIPLY";break;case Xu:e="ENVMAP_BLENDING_MIX";break;case Ku:e="ENVMAP_BLENDING_ADD";break}return e}function jm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Zm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Xm(t),c=Km(t),u=Ym(t),h=$m(t),d=jm(t),p=t.isWebGL2?"":Fm(t),g=Gm(t),_=Bm(r),m=s.createProgram();let f,y,v=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    `,this._input=this.root.querySelector(".nav-search-input"),this._resultsEl=this.root.querySelector(".nav-search-results"),this._modeButton=this.root.querySelector(".mode-toggle")}_bindEvents(){this._input.addEventListener("input",()=>this._handleInput()),this._input.addEventListener("keydown",e=>this._handleKeydown(e)),this._modeButton.addEventListener("click",()=>this._toggleMode()),document.addEventListener("click",e=>{this.root.contains(e.target)||this._closeResults()})}_handleInput(){const e=this._input.value;this.store.dispatch(Ce.setSearchQuery(e));try{this._results=Av(e)}catch(t){console.error("[NavigationSearch] search failed:",t),this._results=[]}this._activeIndex=this._results.length>0?0:-1,this._renderResults()}_handleKeydown(e){if(this._results.length!==0)if(e.key==="ArrowDown")e.preventDefault(),this._activeIndex=(this._activeIndex+1)%this._results.length,this._renderResults();else if(e.key==="ArrowUp")e.preventDefault(),this._activeIndex=(this._activeIndex-1+this._results.length)%this._results.length,this._renderResults();else if(e.key==="Enter"){e.preventDefault();const t=this._results[this._activeIndex]??this._results[0];t&&this._selectResult(t)}else e.key==="Escape"&&this._closeResults()}_renderResults(){if(this._results.length===0){this._resultsEl.hidden=!0,this._resultsEl.innerHTML="";return}this._resultsEl.hidden=!1,this._resultsEl.innerHTML=this._results.map((e,t)=>`
      ...
      <div class="detail-panel">
        ...
        <dl class="detail-fields">
          ...
          <div><dt>Distance from Earth</dt><dd>${bt(nc(e.distanceFromEarthKm))}</dd></div>
          ...
          <div id="tab-content-discoveries" class="logbook-tab-content">
            <section class="logbook-stats-bar">
              ...
              <div class="stat-card">
                ...
                <span id="logbook-stat-badges" class="stat-value">1 / ${_a.length}</span>
              </div>
            </section>
    ...
    `}_wireEvents(){const e=this.root.querySelector("#logbook-modal-backdrop"),t=this.root.querySelector("#logbook-close-btn"),n=this.root.querySelectorAll(".tab-btn"),s=this.root.querySelectorAll(".filter-chip");t?.addEventListener("click",()=>this.close()),e?.addEventListener("click",r=>{r.target===e&&this.close()}),n.forEach(r=>{r.addEventListener("click",()=>{n.forEach(l=>l.classList.remove("active")),r.classList.add("active"),this.activeTab=r.getAttribute("data-tab")||"discoveries";const a=this.root.querySelector("#tab-content-discoveries"),o=this.root.querySelector("#tab-content-expeditions");a&&(a.hidden=this.activeTab!=="discoveries"),o&&(o.hidden=this.activeTab!=="expeditions"),this.activeTab==="expeditions"&&this._renderExpeditions()})}),s.forEach(r=>{r.addEventListener("click",()=>{s.forEach(a=>a.classList.remove("active")),r.classList.add("active"),this.activeFilter=r.getAttribute("data-filter")||"all",this._updateList()})})}_onStateChange(e){const t=this.root.querySelector("#logbook-modal-backdrop");t&&(t.hidden=!e),e&&(this._updateContent(),this._renderExpeditions())}_updateContent(){const e=this.store.getState(),t=e.discoveries||[],n=this.root.querySelector("#logbook-stat-discovered");n&&(n.textContent=`${t.length} / ${en.length+wn.length}`);const s=this.root.querySelector("#logbook-badges-grid");if(s){let r=0;s.innerHTML=_a.map(o=>{const l=o.condition(t,e);return l&&r++,`
        ...
        `}).join("");const a=this.root.querySelector("#logbook-stat-badges");a&&(a.textContent=`${r} / ${_a.length}`)}this._updateList()}_renderExpeditions(){const e=this.root.querySelector("#expeditions-container");if(!e)return;const t=this.store.getState(),n=t.activeExpedition,s=t.completedExpeditions||[];e.innerHTML=lc.map(r=>{const a=s.some(u=>u.expeditionId===r.id),o=n&&n.id===r.id,l=o?n.currentStepIndex:0,c=r.waypoints.map((u,h)=>{const d=a||o&&h<l;return`
      ...
      `}).join(""),e.querySelectorAll(".exp-action-btn").forEach(r=>{r.addEventListener("click",()=>{const a=r.getAttribute("data-exp-id");if(!a)return;const o=lc.find(u=>u.id===a);if(!o)return;const l=this.store.getState();(!l.activeExpedition||l.activeExpedition.id!==a)&&this.store.dispatch(Ce.startExpedition(a));const c=o.waypoints[0].targetId;this.close(),this.onSelectTarget?.(c,"celestial")})})}_updateList(){const e=this.root.querySelector("#logbook-list");if(!e)return;const s=(this.store.getState().discoveries||[]).filter(r=>this.activeFilter==="all"?!0:this.activeFilter==="satellite"?r.kind==="satellite":r.kind!=="satellite");if(s.length===0){e.innerHTML='<div class="logbook-empty">No discoveries in this category yet. Take flight and explore the stars!</div>';return}e.innerHTML=s.map(r=>{const a=r.discoveredAt?new Date(r.discoveredAt).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"Initial";return`
